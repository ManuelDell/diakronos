...
- **Ressourcenplan** – alle Räume auf einen Blick, wer hat wann gebucht
...
> ✨ **Kronos ist jetzt vollständig in die Diakonos Vue-SPA integriert** – einheitliches Layout, gemeinsame Sidebar und durchgängige Navigation.
