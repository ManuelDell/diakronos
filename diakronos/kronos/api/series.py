# diakronos/kronos/api/series.py
"""
Serientermine – Batch-Update und Löschen
"""
...
def delete_series_batch_fast(series_id):
    ...
    if not elements:
        return {"success": True, "deleted_count": 0, "message": _("Keine Termine in dieser Serie gefunden")}
    ...
    frappe.db.commit()
    return {"success": True, "deleted_count": deleted_count, "message": _("{0} Termine gelöscht").format(deleted_count)}
